  ...
  if (state === "loading") {
    return (
      <div className="flex flex-col items-center gap-3 select-none">
        ...
        />
        <span className="text-sm text-muted-foreground/50">{t("Loading conversation")}</span>
      </div>
    );
  }
  return (
    <div className="flex flex-col items-center gap-3 select-none">
      <span className="text-sm text-muted-foreground">{t("This conversation didn't load.")}</span>
