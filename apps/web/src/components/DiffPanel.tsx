...
export default function DiffPanel({
  ...
  const gitRepoStatusError = gitBranchesQuery.error ? t("Failed to check git repository.") : null;
  ...
  const localizedCheckpointDiffError = checkpointDiffError
    ? tError(checkpointDiffError, "Failed to load checkpoint diff.")
    : null;
  ...
  const repoDiffError = repoDiffQuery.error ? t("Failed to load repo diff.") : null;
  ...
  const activeReviewError = diffViewKind === "repo" ? repoDiffError : localizedCheckpointDiffError;
            ...
            <DiffPanelPatchViewport
              ...
              loadingLabel={
                diffViewKind !== "repo"
                  ...
                  : repoDiffScope === "ref"
                    ? `${t("Loading diff:")} ${resolveRepoDiffScopeLabel(repoDiffScope, repoDiffCompareRef)}...`
                    : `${t("Loading diff:")} ${t(REPO_DIFF_SCOPE_LABELS[repoDiffScope])}...`
              }
              emptyLabel={
                diffViewKind === "repo"
